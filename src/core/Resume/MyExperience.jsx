...
import {resumeExperience} from "../../data/resumeExperience"

const MyExperience = () => {
  return (
    <>
      <div className='text-white'>
              <p className='text-3xl font-semibold'>My Experience</p>
              <p className='text-sm text-richblack-300 mt-5 mb-6'>Lorem ipsum, dolor 
